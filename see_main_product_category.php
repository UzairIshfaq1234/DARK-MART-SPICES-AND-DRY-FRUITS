    ...
    <div class="orders">
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <h3 class="box-title" style="font-size:39px;margin-bottom:10px;"><span style="color:red;">ALL <?php echo strtoupper($cat1);?> </span> PRODUCT </h3>
