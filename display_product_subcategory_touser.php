                ...
                <div class="col-xs-12">
                    <div class="bradcaump__inner">
                        <nav class="bradcaump-inner">
                            <a class="breadcrumb-item" href="first_page.php"><?php echo "$catego"; ?></a>
                            ...
                            for ($i = 0; $i < $display_category_rows; $i++) {
                                ...
                                if ($status == "Active") {
                                    echo " <span class='brd-separetor'><i class='zmdi zmdi-chevron-right'></i></span>
                                         <a class='breadcrumb-item' href='show_sub_catgerory.php?sub=$categories'>$categories</a>
    ";
                                }
                            }
                            ?>
                    ...
                    <div class="row">
                        <div class="shop__grid__view__wrap">
                            <div role="tabpanel" id="grid-view" class="single-grid-view tab-pane fade in active clearfix">
                                ...
                                $display_category = "SELECT * FROM `product` WHERE main_category='$catego'";
                                $result = mysqli_query($con, $display_category);
                                $display_category_rows = mysqli_num_rows($result);
...
";
    ...
    <div class='ht__list__thumb'>
        <a href='data_of_product.php?item=$product_id&cat=$category'><img src='product_images_category/$image' alt='product images'></a>
    </div>
...
$display_category = "SELECT * FROM `product` WHERE main_category='$catego' ORDER BY `orders` DESC LIMIT 12
;";
$result = mysqli_query($con, $display_category);
$display_category_rows = mysqli_num_rows($result);
