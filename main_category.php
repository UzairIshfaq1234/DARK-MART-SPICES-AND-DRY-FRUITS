...
if (isset($_GET['action']) and $_GET['action']!="") 
{
    ...
    if ($action=="update_status")
    {
        ...
        if($operation=="Deactive")
        {
            ...
            $update_category_status3 = "UPDATE `main_category` SET `status`='Deactive' WHERE `main_category`='$name';";
            $result = mysqli_query($con, $update_category_status3);

            
            $update_category_status1 = "UPDATE `product` SET `status`='outofstock' WHERE `main_category`='$name';";
        ...
        if($operation=="Active")
        {
            ...
            $update_category_status3 = "UPDATE `main_category` SET `status`='Active' WHERE `main_category`='$name';";
            $result = mysqli_query($con, $update_category_status3);

            $update_category_status1 = "UPDATE `product` SET `status`='instock' WHERE `main_category`='$name';";
            $result = mysqli_query($con, $update_category_status1);
        }
    ...
    if($action=="delete_category")
    {
        ...
        $delete_category_fully2 = "DELETE FROM `main_category` WHERE `main_category`='$name';";
        $result = mysqli_query($con, $delete_category_fully2);

        // SELECT * FROM `product` WHERE `category` = 'str'
        $delete_product_fully = "DELETE FROM `product` WHERE `main_category`='$name';";
    ...
    <div class="orders">
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <h3 class="box-title" style="font-size:39px;margin-bottom:10px;">MAIN CATEGORIES </h3>
                        <a href="add_main_category.php" class="addCategories">
                    ...
                    <div class="card-body--">
                        <div class="table-stats order-table ov-h">
                            <table class="table ">
                                <thead>
                                    <tr>
                                        <th class="serial">Main Categories</th>
                                        <th>Product List </th>
                                        <th>Status</th>
                                        <th>Action</th>
                                ...
                                <tbody>
                                    ...
                                    $display_category = "SELECT * FROM `main_category`";
                                    ...
                                    for ($i = 0; $i < $display_category_rows; $i++) {
                                        ...
                                        $category_data = $data['main_category'];
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <span class='badge badge-success'> <a href='see_main_product_category.php?seedata=$category_data' style='color: white;' class='deletecategory'>See Products</a></span>
                                        </td>    
                                        ";
